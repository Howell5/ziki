...
private enum AppUpdateError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .versionMismatch:
            "更新包版本与 Release 不一致"
        case .signatureMismatch:
            "更新包签名与当前 Ziki 不一致，已停止安装"
        case .installationUnavailable:
            "当前安装位置不可更新，请先把 Ziki 放入“应用程序”文件夹"
...
private actor AppUpdateService {
    ...
    func check(
        ...
        request.setValue("Ziki/\(currentVersion)", forHTTPHeaderField: "User-Agent")
    ...
    func launchInstaller(
        ...
        let helperURL = Bundle.main.bundleURL
            .appendingPathComponent("Contents/MacOS/ZikiUpdater")
