-- Generated from authOptions with Better Auth 1.7.4 getMigrations().compileMigrations().
-- Schema drift is checked against the actual D1 binding in test/auth.test.ts.
